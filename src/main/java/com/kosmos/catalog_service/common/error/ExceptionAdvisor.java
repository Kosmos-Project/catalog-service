package com.kosmos.catalog_service.common.error;

import com.kosmos.catalog_service.common.http.CommonResDto;
...
public class ExceptionAdvisor {
    ...
    public ResponseEntity<?> processValidationError(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(400).body(new CommonResDto(dtoMetadata));
    }
}
